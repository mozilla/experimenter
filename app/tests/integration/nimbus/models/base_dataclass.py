...
class BaseExperimentAudienceTargetingOptions(Enum):
    ...
    TARGETING_CASUAL_USER_URIS = ("TARGETING_CASUAL_USERS_URIS",)
    TARGETING_REGULAR_USER_URIS = ("TARGETING_REGULAR_USERS_URIS",)
    TARGETING_CORE_USER_URIS = ("TARGETING_CORE_USERS_URIS",)
