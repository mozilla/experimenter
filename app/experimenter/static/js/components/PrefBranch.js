...
@boundClass
class PrefBranch extends React.Component {
  ...
  render(){
    return (
      <div key={this.props.id} id="control-branch-group">
        <Row className="mb-3">
        ...
        <DesignInput
          label="Pref Value"
          name={"variants[" + this.props.id + "][value]"}
          id={"variants-" + this.props.id + "-value"}
          value={this.props.values.value}
          error={
            this.props.errors.variants ? this.props.errors.variants[this.props.index].value : ""
          }
