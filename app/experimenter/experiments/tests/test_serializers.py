...
class TestExperimentSerializer(TestCase):
    ...
    def test_serializer_outputs_expected_schema(self):
        ...
        self.assertEqual(set(serialized.data.keys()), set(expected_data.keys()))
    ...
    def test_serializer_locales(self):
        ...
        serialized = ExperimentSerializer(experiment)
        self.assertEqual(
            serialized.data["locales"], [{"code": locale.code, "name": locale.name}]
        )
    ...
    def test_serializer_countries(self):
        ...
        serialized = ExperimentSerializer(experiment)
        self.assertEqual(
            serialized.data["countries"], [{"code": country.code, "name": country.name}]
        )
