...
class TestChangeLogMixin(MockRequestMixin, TestCase):
    ...
    def test_changelog_values_with_prev_log(self):
        ...
        locales = [{"code": "da", "name": "Danish"}, {"code": "de", "name": "German"}]
        ...
        self.assertCountEqual(
            latest_changes.new_values["locales"],
            [{"code": "bg", "name": "Bulgarian"}, {"code": "de", "name": "German"}],
        )
        self.assertCountEqual(
            [
                {
        ...
        self.assertEqual(latest_changes.old_values["client_matching"], "initial value")
        self.assertEqual(latest_changes.old_values["platform"], Experiment.PLATFORM_MAC)
...
@parameterized_class(
    ["form_class"], [[ExperimentVariantsAddonForm], [ExperimentVariantsPrefForm]]
)
