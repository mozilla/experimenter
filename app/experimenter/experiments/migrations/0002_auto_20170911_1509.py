# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2017-09-11 15:09
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pref_type', models.CharField(choices=[('boolean', 'boolean'), ('integer', 'integer'), ('string', 'string')], max_length=255)),
                ('pref_branch', models.CharField(choices=[('Default', 'Default'), ('User', 'User')], max_length=255)),
