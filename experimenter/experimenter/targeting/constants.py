...
WINDOWS_ONLY = NimbusTargetingConfig(
    name="Windows users only",
    slug="windows_only",
    description="All users with Windows",
    targeting="os.isWindows",
    desktop_telemetry="",
    sticky_required=False,
    is_first_run_required=False,
    application_choice_names=(Application.DESKTOP.name,),
...
WINDOWS_LAUNCH_ON_LOGIN_ELIGIBLE = NimbusTargetingConfig(
    ...
    description=(
        ...
        "have launch on login enabled. Excludes users running an MSIX build on "
        "Windows 10."
    ),
    targeting=(
...
WINDOWS_10_BACKGROUND_TASK_2_TO_4_DAYS_LAPSED = NimbusTargetingConfig(
    name="Lapsed users background task notification, 2 to 4 days old",
    slug="background_task_notification_2_to_4_days",
    description=(
        "Windows 10+ users with no activity in the past day, "
        "with profiles 2 to 4 days old, "
...
FX_153_3_TRAINHOP = NimbusTargetingConfig(
    ...
    targeting="newtabAddonVersion|versionCompare('153.3.20260605.21338') >= 0",
    desktop_telemetry="",
    sticky_required=False,
    is_first_run_required=False,
    application_choice_names=(Application.DESKTOP.name,),
...
FX_154_TRAINHOP = NimbusTargetingConfig(
    ...
    targeting="newtabAddonVersion|versionCompare('154.1.20260619.43329') >= 0",
    desktop_telemetry="",
    sticky_required=False,
    is_first_run_required=False,
    application_choice_names=(Application.DESKTOP.name,),
...
FX_155_TRAINHOP = NimbusTargetingConfig(
    ...
    description=(
        ...
        "which includes users of Fx153"
    ),
    targeting="newtabAddonVersion|versionCompare('155.1.20260811.195042') >= 0",
    desktop_telemetry="",
    sticky_required=False,
    is_first_run_required=False,
    application_choice_names=(Application.DESKTOP.name,),
...
EXISTING_USER_NO_ENTERPRISE = NimbusTargetingConfig(
    ...
    description=(
        "Existing users with a profile older than 14 days, "
        "without active enterprise policies, "
        "and feature recommendations enabled"
    ),
    targeting=(
        f"{PROFILEMORETHAN14DAYS}"
        f" && {NO_ENTERPRISE.targeting}"
