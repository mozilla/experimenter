...
urlpatterns = [
    ...
    re_path(
        r"^new/(?P<slug>[\w-]+)/start_rollout_phase/$",
        NewRolloutStartPhaseView.as_view(),
        name="nimbus-ui-new-start-rollout-phase",
    ),
    re_path(
        r"^new/(?P<slug>[\w-]+)/pause_rollout/$",
        NewRolloutPauseView.as_view(),
        name="nimbus-ui-new-pause-rollout",
    ),
    re_path(
