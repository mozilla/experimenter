...
class NimbusFeaturesView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context = {
            ...
            "paginator": paginator,
            "page_obj": page_obj,
            "experiments": page_obj.object_list,
            "sortable_header_deliveries": FeaturesPageSortChoices.sortable_headers(
                FeaturesPageSortChoices.Deliveries
            ),
            "sortable_header_qa_runs": FeaturesPageSortChoices.sortable_headers(
