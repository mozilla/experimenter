...
it("languages and countries fields are enable for web application", async () => {
  render(
    <Subject
      experiment={{
        ...MOCK_EXPERIMENT,
  ...
  expect(selectCountriesElement).toBeEnabled();
  ...
  expect(selectLanguagesElement).toBeEnabled();
});
