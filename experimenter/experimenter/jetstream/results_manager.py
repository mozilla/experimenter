...
class ExperimentResultsManager:
    ...
    def get_overall_change(
        ...
        for branch_slug, branch_data in branch_results.items():
            ...
            if metric_significance == MetricSignificance.POSITIVE:
                if overall_change == MetricSignificance.NEGATIVE:
                    overall_change = MetricSignificance.MIXED
                    break
                overall_change = MetricSignificance.POSITIVE
            elif metric_significance == MetricSignificance.NEGATIVE:
                if overall_change == MetricSignificance.POSITIVE:
                    overall_change = MetricSignificance.MIXED
                    break
