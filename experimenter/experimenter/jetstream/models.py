...
class DataPoint(BaseModel):
    ...
    def has_bounds(self) -> bool:
        return self.lower and self.upper # TODO: should these be `is not None` checks?
...
def create_results_object_model(data: JetstreamData):
    ...
    class PairwiseMetricData(MetricData):
        difference: PairwiseBranchComparisonData = Field(default_factory=PairwiseBranchComparisonData)
        relative_uplift: PairwiseBranchComparisonData = Field(default_factory=PairwiseBranchComparisonData)
        significance: PairwiseSignificanceData = Field(default_factory=PairwiseSignificanceData)
