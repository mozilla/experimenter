    ...
    def test_outputs_expected_schema_for_empty_experiment(self):
        ...
        self.assertEqual(
            data,
            {
                ...
                "countries": [],
                "do_rerun": experiment.do_rerun,
                "do_rerun_timestamp": experiment.do_rerun_timestamp,
                ...
                "is_holdback": experiment.is_holdback,
    ...
    def test_outputs_expected_schema_for_complete_experiment(self):
        ...
        self.assertEqual(
            data,
            {
                ...
                "sizing_data": experiment.sizing_data,
                "sizing_data_updated_at": experiment.sizing_data_updated_at,
                "name": experiment.name,
                "newtab_addon_min_version": experiment.newtab_addon_min_version,
                "next_steps": None,
                ...
                "rollout_plan_name": experiment.rollout_plan_name,
                "secondary_outcomes": [secondary_outcome],
                "segments": [segment],
