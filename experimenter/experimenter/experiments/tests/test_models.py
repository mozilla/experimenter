...
class TestNimbusExperiment(TestCase):
    ...
    def test_clone_created_experiment(self):
        ...
        self.assertEqual(child.channels, [])
    ...
    def _clone_experiment_and_assert_common_expectations(
        ...
        self.assertEqual(child.channels, parent.channels)
    ...
    def test_monitoring_summary_healthy(self):
        experiment = NimbusExperimentFactory.create(
            monitoring_data={
    ...
    def test_monitoring_summary_unenrollment_spike_detected(self):
        experiment = NimbusExperimentFactory.create(
            monitoring_data={
                "total_enrollments": 1000,
                ...
                "branches": {
                    ...
                    "treatment": {"enrollments": 500, "unenrollments": 75},
                },
                "reasons_by_branch": {},
            }
        )
        summary = experiment.monitoring_summary
        self.assertTrue(summary["is_unenrollment_spike"])
        self.assertFalse(summary["is_srm"])

    def test_monitoring_summary_srm_detected(self):
        experiment = NimbusExperimentFactory.create(
            monitoring_data={
                "total_enrollments": 1000,
                "total_unenrollments": 50,
...
class TestAdvanceRolloutPhase(TestCase):
    ...
    def test_advance_replaces_estimated_current_phase_end_date(self):
    ...
    def test_resuming_disabled_rollout_preserves_previous_phase_end_date(self):
        previous_end_date = timezone.now().date() - datetime.timedelta(days=3)
        self.phases[0].end_date = previous_end_date
        self.phases[0].save()
        self.experiment.status = NimbusExperiment.Status.DISABLED
        self.experiment.rollout_phase = self.phases[0]
        self.experiment.rollout_phase_next = self.phases[1]
        self.experiment.save()
