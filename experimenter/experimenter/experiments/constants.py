...
DESKTOP_NEWTAB_ADDON_SLUG = "newtabTrainhopAddonDeployment"
DESKTOP_NEWTAB_ADDON_LEGACY_SLUG = "newtabTrainhopAddon"
...
APPLICATION_CONFIG_DESKTOP = ApplicationConfig(
    ...
    kinto_collections_by_feature_id={
        ...
        DESKTOP_NEWTAB_ADDON_LEGACY_SLUG: settings.KINTO_COLLECTION_NIMBUS_SECURE,
    },
...
class NimbusConstants:
    ...
    DESKTOP_NEWTAB_ADDON_LEGACY_SLUG = DESKTOP_NEWTAB_ADDON_LEGACY_SLUG
    ...
    class AlertType(models.TextChoices):
        ...
        NOT_UNENROLLING = "not_unenrolling", "Not Unenrolling"
...
Optional - We believe this outcome will <describe impact> on <core metric>
    ...
    NOT_UNENROLLING_DAYS_THRESHOLD = 3
    NOT_UNENROLLING_CLIENT_THRESHOLD = 1000
    NOT_UNENROLLING_MIN_ENROLLMENTS = 1000
    POST_END_MONITORING_DAYS = NOT_UNENROLLING_DAYS_THRESHOLD + 1
