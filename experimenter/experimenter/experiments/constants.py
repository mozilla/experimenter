...
class ApplicationConfig:
    ...
    remote_settings_collection: str
...
APPLICATION_CONFIG_DESKTOP = ApplicationConfig(
    ...
    remote_settings_collection=settings.REMOTE_SETTINGS_COLLECTION_NIMBUS_DESKTOP,
...
APPLICATION_CONFIG_FENIX = ApplicationConfig(
    ...
    remote_settings_collection=settings.REMOTE_SETTINGS_COLLECTION_NIMBUS_MOBILE,
