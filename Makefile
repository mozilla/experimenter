...
cirrus_build_test: build_megazords
	$(CIRRUS_ENABLE) $(DOCKER_BUILD) $(CIRRUS_BUILD_FLAGS) --target dev -f cirrus/server/Dockerfile -t cirrus:dev --build-context fml=experimenter/experimenter/features/manifests/ cirrus/server/
