...
integration_test_nimbus_fenix:
	...
	cd experimenter/tests && poetry run pytest -v -m fenix_enrollment -o addopts= --junitxml=integration/test-reports/fenix_enrollment.xml integration/nimbus/android $(PYTEST_ARGS)
