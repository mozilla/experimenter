...
- `CIRRUS_REMOTE_SETTING_REFRESH_DELAY_IN_SECONDS`: The delay in seconds bewteen attempts after failing to fetch from remote settings. Set it to `30` to wait 30 seconds between attempts.
