...
class TestCirrusMain:
    def test_create_fml_with_error(self):
    ...
    def test_create_sdk_with_error(self):
    ...
    async def test_fetch_schedule_recipes_success(
        self, scheduler_mock, remote_setting_mock
    ):
    ...
    async def test_fetch_schedule_recipes_failure(
        self, scheduler_mock, remote_setting_mock, exception
    ):
